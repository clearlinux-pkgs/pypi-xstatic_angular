...
License  : MIT
Requires: pypi-xstatic_angular-python = %{version}-%{release}
Requires: pypi-xstatic_angular-python3 = %{version}-%{release}
...
%package python
Summary: python components for the pypi-xstatic_angular package.
Group: Default
Requires: pypi-xstatic_angular-python3 = %{version}-%{release}

%description python
python components for the pypi-xstatic_angular package.


%package python3
Summary: python3 components for the pypi-xstatic_angular package.
Group: Default
Requires: python3-core
Provides: pypi(xstatic_angular)

%description python3
python3 components for the pypi-xstatic_angular package.


%prep
%setup -q -n XStatic-Angular-1.8.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707150615
